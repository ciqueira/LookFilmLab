...
constexpr ChoiceOption kStaticOptions[] = {
  ...
  {"primariesColorSpace", "Rec.709 / sRGB"},
...
constexpr SpektraAppParamDescriptor kParams[] = {
  ...
  param("inputPrimariesColorSpace", "Input Color Space", "color", SpektraAppParamKindChoice, kParamTagFlow, 1, 0.0, 0.0, 0.0, 0.0, 17.0, "primariesColorSpace"),
  param("inputTransferColorSpace", "Input Gamma", "color", SpektraAppParamKindChoice, kParamTagFlow, 1, 0.0, 0.0, 0.0, 0.0, 17.0, "transferColorSpace"),
  param("outputPrimariesColorSpace", "Output Color Space", "color", SpektraAppParamKindChoice, kParamTagFlow, 12, 0.0, 0.0, 0.0, 0.0, 17.0, "primariesColorSpace"),
  param("outputTransferColorSpace", "Output Gamma", "color", SpektraAppParamKindChoice, kParamTagFlow, 17, 0.0, 0.0, 0.0, 0.0, 17.0, "transferColorSpace"),
...
SpektraAppRenderParams SpektraAppMakeDefaultRenderParams(void) {
  ...
  p.inputPrimariesColorSpace = 1;
  p.inputTransferColorSpace = 1;
  p.outputPrimariesColorSpace = 12;
  p.outputTransferColorSpace = 17;
