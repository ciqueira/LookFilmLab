...
enum class ScanInputEncoding : int32_t {
  Linear = 0,
  Srgb = 1,
  Rec709Gamma24 = 2,
  Rec709Gamma22 = 3,
...
enum class ScanDensityBasis : int32_t {
  NeutralCmy = 0,
  SelectedNegativeStock = 1,
};
...
struct RenderParams {
  ...
  ColorSpace inputColorSpace = ColorSpace::ArriLogC3Ei800;
  ColorSpace outputColorSpace = ColorSpace::Rec709Gamma24;
  ColorSpace inputPrimariesColorSpace = ColorSpace::LinearRec2020;
  ColorSpace inputTransferColorSpace = ColorSpace::LinearRec2020;
  ColorSpace outputPrimariesColorSpace = ColorSpace::LinearRec709;
  ColorSpace outputTransferColorSpace = ColorSpace::Rec709Gamma24;
  ...
  ScanInputEncoding scanInputEncoding = ScanInputEncoding::Linear;
  ColorSpace scanInputColorSpace = ColorSpace::LinearRec709;
  ColorSpace scanWorkingColorSpace = ColorSpace::LinearRec2020;
  ScanDensityBasis scanDensityBasis = ScanDensityBasis::NeutralCmy;
  float scanFilmBaseR = 1.0f;
  float scanFilmBaseG = 1.0f;
  float scanFilmBaseB = 1.0f;
  float scanFilmBaseColorR = 1.0f;
  float scanFilmBaseColorG = 0.78f;
  float scanFilmBaseColorB = 0.58f;
  float scanFilmBaseTemp = 0.0f;
  float scanFilmBaseTint = 0.0f;
  float scanBlackFlareR = 0.0f;
  float scanBlackFlareG = 0.0f;
  float scanBlackFlareB = 0.0f;
  float scanExposureEv = 0.0f;
  float scanDensityContrast = 1.5f;
  float scanDensityScaleR = 1.0f;
  float scanDensityScaleG = 1.0f;
  float scanDensityScaleB = 1.0f;
  float scanDensityOffsetR = 0.0f;
  float scanDensityOffsetG = 0.0f;
  float scanDensityOffsetB = 0.0f;
